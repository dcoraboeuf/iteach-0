...
public interface SQL {
    ...
    String LESSONS_ALL_FOR_TEACHER = "SELECT L.* FROM LESSONS L INNER JOIN STUDENTS S ON S.ID = L.STUDENT INNER JOIN SCHOOLS H ON H.ID = S.SCHOOL WHERE H.TEACHER = :teacher AND S.DISABLED IS FALSE ORDER BY H.NAME, S.NAME";
