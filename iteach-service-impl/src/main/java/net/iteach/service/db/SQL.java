...
public interface SQL {
	...
	String USER_CREATE = "INSERT INTO USERS (ADMINISTRATOR, MODE, IDENTIFIER, PASSWORD, EMAIL, FIRSTNAME, LASTNAME) VALUES (:administrator, :mode, :identifier, :password, :email, :firstName, :lastName)";

	String USER_BY_OPENID = "SELECT ID, EMAIL, FIRSTNAME, LASTNAME, ADMINISTRATOR FROM USERS WHERE MODE = 'openid' AND IDENTIFIER = :identifier";

	String USER_BY_PASSWORD = "SELECT ID, PASSWORD, EMAIL, FIRSTNAME, LASTNAME, ADMINISTRATOR FROM USERS WHERE MODE = 'password' AND IDENTIFIER = :identifier";
