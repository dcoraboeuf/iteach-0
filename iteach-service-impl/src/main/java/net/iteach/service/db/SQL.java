...
public interface SQL {
	...
	String REPORT_MONTHLY = "SELECT L.PFROM, L.PTO, L.STUDENT AS STUDENT, S.NAME AS STUDENT_NAME, S.SCHOOL AS SCHOOL, H.NAME AS SCHOOL_NAME, H.COLOR AS SCHOOL_COLOR FROM LESSONS L INNER JOIN STUDENTS S ON S.ID = L.STUDENT INNER JOIN SCHOOLS H ON H.ID = S.SCHOOL WHERE H.TEACHER = :teacher AND L.PDATE >= :from AND L.PDATE <= :to ORDER BY H.NAME, S.NAME";
